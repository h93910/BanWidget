...
public class MyAppWidgetProvider extends AppWidgetProvider {
	...
	private void checkFestival(AppWidgetManager appWidgetManager,
		...
		String dongLiJie = banDB.getNongLiFestivalName(ChinaDate
				.todayNumberString());
		if (!dongLiJie.equals("")) {
			buffer.append(dongLiJie + "和");
		}

		String xinLiJie = banDB.getXinLiFestivalName(ChinaDate
				.getXinLiTodayString());
		if (!xinLiJie.equals("")) {
			buffer.append(xinLiJie + "和");
		}
